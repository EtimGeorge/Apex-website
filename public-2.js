...
// Wait for the entire window to load (including images, etc.)
...
document.addEventListener('DOMContentLoaded', () => {
  // =======================================================================
  // --- General Site-Wide Logic (Runs on every page) ---
  // =======================================================================
  ...
  // =======================================================================
  // --- Page-Specific Logic (Router to run functions only when needed) ---
  // =======================================================================
  ...
  const loadPublicPlans = async () => {
    ...
    if (!publicPlansGrid) return; // Only run if the element exists
  ...
  if (page === 'post.html') {
    loadSinglePost(); // This function will internally call like/comment handlers
    loadRelatedPosts();
  }

  // =======================================================================
  // --- Blog Interaction Handlers (Called by loadSinglePost) ---
  // =======================================================================
